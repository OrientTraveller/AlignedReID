...
class Market1501(object):
    ...
    def __init__(self, root='./'):
        ...
        train, num_train_pids, num_train_imgs = self.__process_dir__(self.train_dir, relabel=True)
        query, num_query_pids, num_query_imgs = self.__process_dir__(self.query_dir, relabel=False)
        gallery, num_gallery_pids, num_gallery_imgs = self.__process_dir__(self.gallery_dir, relabel=False)
    ...
    def __process_dir__(self, dir_path, relabel=False):
